...
def hxrss_io_crystal_parameters_default():
    ...
    d.dthp = 1.335 #-0.392      # pitch angle
    d.dthy = -0.2#1.17        # roll angle (American convention)
    d.dthr = -0.295#-0.1675      # yaw angle (American convention)
    d.alpha =0 #0.00238    # alpha parameter: for different pitch angles, different rolls are needed to bring the lines together
    d.roll_list = [1.58]
    return d
