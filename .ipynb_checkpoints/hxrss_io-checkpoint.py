...
def thread_read_worker(qin, qout, dbg=False):
    ...
    while True:
        ...
        r.mono1_insert_busy  = mono_motor_busy('XFEL.FEL/UNDULATOR.SASE2/MONOCI.2252.SA2/')
        r.mono2_insert_busy  = mono_motor_busy('XFEL.FEL/UNDULATOR.SASE2/MONOCI.2307.SA2/')
