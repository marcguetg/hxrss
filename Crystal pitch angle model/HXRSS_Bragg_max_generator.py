...
#####
    ...
    def phev_min(fact, n, h, k, l, a, thp, thy_not_used, thr, n0, pitchax, rollax, yawax,    dthy, alpha, roll_angle):
        ...
        # range of interest
        # Results: i) minimum for minimization procedure
